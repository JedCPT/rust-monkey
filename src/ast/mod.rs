    ...
    fn eval(&self, env: Rc<RefCell<Enviroment>>) -> Rc<Object> {
        ...
        if value.is_none() {
            return Rc::new(object::Error {
                message: format!("Variable {} not in scope.", self.token.literal).to_string(),
            });
        }
        ...
        return Rc::new(object::Error {
            message: format!("Variable {} in scope but not returned.", self.token.literal)
                .to_string(),
        });
    }
...
impl Node for PrefixExpression {
    ...
    fn eval(&self, env: Rc<RefCell<Enviroment>>) -> Rc<Object> {
        ...
        match self.token.token_type {
            ...
            _ => {
                return Rc::new(object::Error {
                    message: "Error: Prefix operator not - or !..".to_string(),
                });
            }
        }
    }
...
impl InfixExpression {
    fn eval_boolean_infix_expression(&self, left: &Rc<Object>, right: &Rc<Object>) -> Rc<Object> {
        ...
        return Rc::new(object::Error {
            message: "Boolean infix being evaluated with invalid operand.".to_string(),
        });
    }
